...
Knowledge base on complex systems, extracted from [Juanje Ojeda's blog](https://blog.juanjeojeda.com/).

## System Properties

Core characteristics and properties of complex systems.

- [Attractors](system-properties/attractors.md) — States toward which systems tend to evolve
- [Black Swan Events](system-properties/black-swan-events.md) — Disproportionate, unpredictable events from non-linear dynamics
- [Complex Systems](system-properties/complex-systems.md) — Foundational definition of complex adaptive systems
- [Complex vs. Complicated](system-properties/complex-vs-complicated.md) — Structural vs. epistemic distinction
- [Diversity in Complex Systems](system-properties/diversity-in-complex-systems.md) — Heterogeneity of component types
- [Emergence](system-properties/emergence.md) — New properties arising from relationships between components
- [Feedback](system-properties/feedback.md) — Output redirected as input for self-regulation
- [Interconnection and Interdependence](system-properties/interconnection-and-interdependence.md) — How connections between elements drive emergence
- [Multilevel Organization](system-properties/multilevel-organization.md) — Nested hierarchy of systems within systems
- [Non-linearity](system-properties/non-linearity.md) — Disproportionate cause-effect relationships
...
How agents interact and produce system-level behavior.
...
- [Externality](agents-and-dynamics/externality.md) — Effects on non-participants in an action
- [Network Science](agents-and-dynamics/network-science.md) — Study of interconnected elements and their dynamics
- [Perception-Action Coupling](agents-and-dynamics/perception-action-coupling.md) — Inseparable link between perception and action
- [Schelling Segregation Model](agents-and-dynamics/schelling-segregation-model.md) — Micro-tolerance producing macro-segregation
- [Self-Organization](agents-and-dynamics/self-organization.md) — Global patterns from local interactions without central control
- [Strong and Weak Agents](agents-and-dynamics/strong-and-weak-agents.md) — Spectrum from fixed-rule to learning agents
- [Threshold](agents-and-dynamics/threshold.md) — Critical value triggering state change
...
- [Linear-Deterministic Thinking](complex-problems/linear-deterministic-thinking.md) — The trap of applying proportional reasoning
- [Optimization in Complex Systems](complex-problems/optimization-in-complex-systems.md) — Why optimization is counterproductive in dynamic systems
...
Games, play, and simulation as tools for working with complex systems.

- [Calibration](play-and-games/calibration.md) — Perception-action tuning through repeated practice
- [Game Design for Complex Systems](play-and-games/game-design-for-complex-systems.md) — Framework for designing games as system simulations
- [Play in Complex Systems](play-and-games/play-in-complex-systems.md) — Free exploratory activity as a complexity tool
